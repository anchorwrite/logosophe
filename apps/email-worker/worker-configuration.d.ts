/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv` (hash: 8e18626ae30fd31e8b4b08c817801142)
// Runtime types generated with workerd@1.20250730.0 2024-12-30 nodejs_compat
declare namespace Cloudflare {
	interface Env {
		EMAIL_FROM_ADDRESS: "phil@anchorwrite.net";
		EMAIL_TO_ADDRESS: "phil@anchorwrite.net";
		DB: D1Database;
		EMAIL: SendEmail;
	}
}
