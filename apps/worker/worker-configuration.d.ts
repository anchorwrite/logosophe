/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv` (hash: 2dd823b00cb6bfc8cfd601cd2b3bf32f)
// Runtime types generated with workerd@1.20250730.0 2024-12-30 global_fetch_strictly_public,nodejs_compat
declare namespace Cloudflare {
	interface Env {
		...
		WORKFLOW_DO: DurableObjectNamespace /* WorkflowDurableObject */;
		USER_NOTIFICATIONS_DO: DurableObjectNamespace /* UserNotificationsDurableObject */;
		MEDIA_BUCKET: R2Bucket;
		NEXT_INC_CACHE_R2_BUCKET: R2Bucket;
		DB: D1Database;
		WORKER_SELF_REFERENCE: Service<typeof import("./app/worker-entry").default>;
		ASSETS: Fetcher;
	}
}
