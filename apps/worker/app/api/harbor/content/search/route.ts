...
export async function GET(request: NextRequest) {
  try {
    ...
    // Search published content by title, author, or description
    let sql = `
      SELECT 
        pc.Id,
        pc.MediaId,
