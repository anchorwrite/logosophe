// Internal Blog Preview API Route
// GET: Get internal preview of blog posts for a handle (doesn't require public status)
...
// =============================================================================
// GET - Get internal preview of blog posts for a handle
// =============================================================================

export async function GET(
  request: NextRequest,
  { params }: { params: Promise<{ email: string; handle: string }> }
) {
  try {
    ...
    const { email, handle } = await params;
